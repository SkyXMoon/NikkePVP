  ...
  const sections = [
    {
      title: "竞技场模式",
      items: [
        "普通竞技场默认显示防守队与进攻队，当前选中队伍会高亮，图表同时对比双方充能。",
    ...
    },
    {
      ...
      items: [
        ...
        "普通竞技场的 1-10 方案可拖拽复制到其他方案；目标方案有队伍时会先确认覆盖。",
    ...
    },
    {
      ...
      items: [
        ...
        "红莲可设置反击开关和弹容；计算空枪关闭时，红莲按不缺弹处理。",
        "小红帽可设置穿透计数；罗珊娜可设置队友献祭帧，并可一键重置默认。",
    ...
    },
    {
      ...
      items: [
        ...
        "图片会先进入选区流程，只上传选区内容到 OCR，便于提高识别率并减少上传大小。",
        "OCR 会过滤识别文本并匹配角色名，按顺序从当前模式第一队开始填入空位，满队后自动进入下一队。",
        "识别到的角色会在提示中列出；识别错误、超时或图片过大时会显示右下角提示。",
      ],
    },
    {
      title: "分享",
    ...
    },
    {
      ...
      items: [
        ...
        "右侧“分享”用于分享当前队伍信息；“识别”用于从图片 OCR 填队。",
