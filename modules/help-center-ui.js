const De=9e4,E=new Map;let v={},r={},D={},$="",N="help",R=5;function te(t={}){v=t||{},r=v.state||{},D=v.els||{},$=v.endpoint||"",N=v.shareUrlParam||"help",R=Number(v.teamSize||5)}function c(t,e=null){const u=v[t];return typeof u=="function"?u:e||(()=>{})}function n(t,e){return c("localize",(u,l)=>u||l||"")(t,e)}function a(t){return c("escapeHtml",e=>String(e??""))(t)}function i(t){return c("showToast")(t)}function T(...t){return c("handleRejectedAuthSessionResponse")(...t)}function H(t=!1){return c("getHelpCenterHeaders")(t)}function w(){return c("buildHelpCenterPayload",()=>({}))()}function M(t){return c("isHelpCenterSolvableArenaMode",e=>e==="normal"||e==="special")(t)}function x(t,e){return c("hasHelpCenterSideMembers",()=>!1)(t,e)}function ne(t){return c("findSolvedHelpCenterRequestForDefense",async()=>null)(t)}function O(t){return c("toHelpCenterProtocolPayload",e=>e)(t)}function U(t,e){return c("getHelpCenterPayloadForRequestMode",u=>u)(t,e)}function ae(t){return c("clearHelpCenterAttackDraft")(t)}function ue(t){return c("clearHelpCenterSolveDraft")(t)}function F(){return c("render")()}function P(t){return c("getHelpCenterModeLabel",e=>String(e||""))(t)}function re(t){return c("getHelpCenterRegionLabel",e=>e==="global"?"Global":"CN")(t)}function le(t,e){return c("getHelpCenterRows",()=>[])(t,e)}function B(t){return c("getCharacterById",()=>null)(t)}function j(t){return c("getCharacterLocalizedName",e=>e?.name||e?.id||"")(t)}function V(t){return c("getAvatarMarkup",()=>'<span class="avatar-fallback"><span class="avatar-fallback-name">?</span></span>')(t)}function z(t){return c("getTeamSlotRarityClass",()=>"")(t)}function oe(...t){return c("renderFeatureTouchCard",()=>"")(...t)}function se(...t){return c("bindFeatureTouchCards")(...t)}function K(){return c("requireHelpCenterLogin",()=>!1)()}function ie(t){return c("applyHelpCenterRequestToSolveWorkspace",()=>!1)(t)}function ce(t){return c("copyTextToClipboard",async()=>{})(t)}function W(t){return c("normalizeHelpCenterRequestId",e=>String(e||"").trim())(t)}function g(){document.removeEventListener("keydown",Y),document.querySelector(".help-center-modal-backdrop")?.remove()}function Y(t){t.key==="Escape"&&g()}async function de(){return import("./help-center-service.js")}function pe(t){(t?.response||t?.payload)&&T(t.response,t.payload)}function fe(t={}){const e=!!t.append,u=new URLSearchParams({limit:"30"}),l=r.helpCenter.filters||{};return(l.status==="open"||l.status==="closed")&&u.set("status",l.status),l.arenaMode&&l.arenaMode!=="all"&&u.set("mode",l.arenaMode),l.region&&l.region!=="all"&&u.set("region",l.region),l.sort&&u.set("sort",l.sort),l.scope&&l.scope!=="all"&&u.set("scope",l.scope),e&&r.helpCenter.nextCursor&&u.set("cursor",r.helpCenter.nextCursor),u}function G(t){const e=new URLSearchParams(t);return e.delete("cursor"),e.toString()}function _(t){const e=t==="global"?"global":"cn";return`<span class="help-center-region-badge is-${a(e)}">${a(re(e))}</span>`}function he(t){const e=E.get(G(t));return!e||Date.now()-e.savedAt>9e4?null:e}function Ce(t,e){E.set(G(t),{savedAt:Date.now(),requests:Array.isArray(e.data)?e.data:[],nextCursor:e.meta?.nextCursor||""})}function be(){E.clear()}async function S(t,e={}){const u=!!e.append,l=!!e.force,s=fe({append:u});let d=!1;if(!u&&!l){const o=he(s);o&&(d=!0,r.helpCenter.loading=!1,r.helpCenter.error="",r.helpCenter.requests=o.requests,r.helpCenter.nextCursor=o.nextCursor,I(t))}d||(r.helpCenter.loading=!0,r.helpCenter.error="",I(t));try{const o=await fetch(`${$}?${s.toString()}`,{headers:await H(!1)}),p=await o.json().catch(()=>null);if(!o.ok||!p?.ok||!Array.isArray(p.data))throw T(o,p),new Error(p?.code||"LOAD_FAILED");r.helpCenter.requests=u?[...r.helpCenter.requests||[],...p.data]:p.data,r.helpCenter.nextCursor=p.meta?.nextCursor||"",u||Ce(s,p)}catch(o){d||(r.helpCenter.error=h(o)),console.warn("[HelpCenter] list failed",o)}finally{r.helpCenter.loading=!1,I(t)}}async function y(t,e){r.helpCenter.loading=!0,r.helpCenter.error="",r.helpCenter.selectedId=e,r.helpCenter.mode="detail",r.helpCenter.detail=null,m(t);try{const u=new URLSearchParams({id:e,solutionLimit:"50"}),l=await fetch(`${$}?${u.toString()}`,{headers:await H(!1)}),s=await l.json().catch(()=>null);if(!l.ok||!s?.ok||!s.data?.request)throw T(l,s),new Error(s?.code||"LOAD_FAILED");r.helpCenter.detail=s.data}catch(u){r.helpCenter.error=n("\u6C42\u52A9\u8BE6\u60C5\u8BFB\u53D6\u5931\u8D25","Failed to load help detail"),console.warn("[HelpCenter] detail failed",u)}finally{r.helpCenter.loading=!1,m(t)}}async function C(t){const e=await de();try{const u=await e.postHelpCenterActionPayload($,t,await H(!0));return be(),u.data||{}}catch(u){throw pe(u),u}}async function ye(t,e={}){if(r.helpCenter.actionPending)return;const u=A(t.querySelector("[data-help-title]")?.value,20),l=A(t.querySelector("[data-help-description]")?.value,100),s=w();if(!u){i(n("\u8BF7\u586B\u5199\u6C42\u52A9\u6807\u9898","Please enter a title."));return}if(!M(s.mode)){i(n("\u4E92\u52A9\u6C42\u52A9\u6682\u65F6\u53EA\u652F\u6301\u666E\u901A\u548C\u7279\u6B8A\u7ADE\u6280\u573A","Help requests currently support Normal and Special Arena only."));return}if(!x(s,"defense")){i(n("\u5F53\u524D\u9632\u5B88\u961F\u4F0D\u4E3A\u7A7A","Current defense team is empty."));return}if(!e.skipSolvedCheck)try{const o=await ne(s);if(o?.id&&window.confirm(n(`\u53D1\u73B0\u76F8\u540C\u9632\u5B88\u5DF2\u6709\u5DF2\u89E3\u51B3\u6C42\u52A9\uFF1A\u300A${o.title||"\u672A\u547D\u540D\u6C42\u52A9"}\u300B\u3002\u786E\u5B9A\u67E5\u770B\u5DF2\u6709\u89E3\u6CD5\uFF1F\u53D6\u6D88\u5219\u7EE7\u7EED\u53D1\u5E03\u3002`,`A solved request with the same defense already exists: "${o.title||"Untitled"}". OK to view it, Cancel to continue publishing.`))){await y(t,o.id);return}}catch(o){console.warn("[HelpCenter] solved duplicate check failed",o)}r.helpCenter.actionPending="create-request";const d=t.querySelector("[data-help-create]");d&&(d.disabled=!0,d.textContent=n("\u53D1\u5E03\u4E2D...","Publishing..."));try{const o=await C({action:"create_request",title:u,description:l,arenaMode:s.mode,region:s.region,defensePayload:O(s)});i(n("\u6C42\u52A9\u5DF2\u53D1\u5E03","Help request created.")),await y(t,o.id)}catch(o){console.warn("[HelpCenter] create request failed",o),i(h(o)),d&&(d.disabled=!1,d.textContent=n("\u786E\u8BA4\u53D1\u5E03","Create"))}finally{r.helpCenter.actionPending=""}}async function me(t){if(r.helpCenter.actionPending)return;const e=r.helpCenter.detail?.request;if(!e?.id)return;const u=U(w(),e.arenaMode);if(u.mode!==e.arenaMode){i(n("\u5F53\u524D\u7ADE\u6280\u573A\u6A21\u5F0F\u4E0E\u6C42\u52A9\u4E0D\u4E00\u81F4","Current arena mode does not match this request."));return}if(!x(u,"attack")){i(n("\u5F53\u524D\u8FDB\u653B\u961F\u4F0D\u4E3A\u7A7A","Current attack team is empty."));return}const l=A(t.querySelector("[data-help-solution-description]")?.value,100);r.helpCenter.actionPending="create-solution";const s=t.querySelector("[data-help-create-solution]");s&&(s.disabled=!0,s.textContent=n("\u63D0\u4EA4\u4E2D...","Submitting..."));try{await C({action:"create_solution",requestId:e.id,attackPayload:O(u),description:l}),i(n("\u89E3\u6CD5\u5DF2\u63D0\u4EA4","Solution submitted.")),ae(e.arenaMode),ue(e.id),F(),await y(t,e.id)}catch(d){console.warn("[HelpCenter] create solution failed",d),i(h(d)),s&&(s.disabled=!1,s.textContent=n("\u63D0\u4EA4\u89E3\u6CD5","Submit solution"))}finally{r.helpCenter.actionPending=""}}async function ve(t,e){try{await C({action:"toggle_solution_vote",solutionId:e}),await y(t,r.helpCenter.detail?.request?.id||r.helpCenter.selectedId)}catch(u){console.warn("[HelpCenter] vote failed",u),i(h(u))}}async function $e(t){const e=r.helpCenter.detail?.request;if(e?.id)try{await C({action:"close_request",requestId:e.id}),await y(t,e.id)}catch(u){console.warn("[HelpCenter] close request failed",u),i(h(u))}}async function ge(t,e){const u=r.helpCenter.detail?.request;if(!(!u?.id||!e))try{await C({action:"accept_solution",requestId:u.id,solutionId:e}),i(n("\u5DF2\u91C7\u7EB3\u89E3\u6CD5\u5E76\u5173\u95ED\u6C42\u52A9","Solution accepted and request closed.")),await y(t,u.id)}catch(l){console.warn("[HelpCenter] accept solution failed",l),i(h(l))}}async function Se(t){const e=r.helpCenter.detail?.request;if(e?.id)try{await C({action:"hide_request",requestId:e.id}),i(n("\u5DF2\u9690\u85CF\u6C42\u52A9","Request hidden.")),r.helpCenter.mode="list",r.helpCenter.detail=null,await S(t)}catch(u){console.warn("[HelpCenter] hide request failed",u),i(h(u))}}async function qe(t,e){const u=r.helpCenter.detail?.request;if(!(!u?.id||!e))try{await C({action:"hide_solution",solutionId:e}),i(n("\u5DF2\u9690\u85CF\u89E3\u6CD5","Solution hidden.")),await y(t,u.id)}catch(l){console.warn("[HelpCenter] hide solution failed",l),i(h(l))}}async function Q(t,e){if(!t||!e)return;const u=window.prompt(n("\u8BF7\u586B\u5199\u4E3E\u62A5\u539F\u56E0\uFF08\u53EF\u7559\u7A7A\uFF09","Report reason (optional)"),"");if(u!==null)try{await C({action:"report_content",targetType:t,targetId:e,reason:A(u,240)}),i(n("\u4E3E\u62A5\u5DF2\u63D0\u4EA4","Report submitted."))}catch(l){console.warn("[HelpCenter] report failed",l),i(h(l))}}function He(t){const e=W(t),u=new URL(window.location.href);return u.search="",u.hash="",u.searchParams.set(N,e),u.toString()}async function we(){const t=r.helpCenter.detail?.request,e=W(t?.id);if(!e){i(n("\u6C42\u52A9\u94FE\u63A5\u751F\u6210\u5931\u8D25","Failed to create request link"));return}try{const u=`${n("\u6C42\u52A9\uFF0C\u8FD9\u4E2A\u961F\u4F0D\u600E\u4E48\u89E3\uFF1A","Help: how should this team be solved?")}
${He(e)}`;await ce(u),i(n("\u5DF2\u590D\u5236\u6C42\u52A9\u94FE\u63A5","Request link copied"))}catch(u){console.warn("[HelpCenter] copy request link failed",u),i(n("\u590D\u5236\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u526A\u8D34\u677F\u6743\u9650","Copy failed. Please check clipboard permission."))}}function Le(t){const e=r.helpCenter.detail?.request;if(e?.id&&K()){if(!M(e.arenaMode)){i(n("\u4E92\u52A9\u89E3\u9898\u6682\u65F6\u53EA\u652F\u6301\u666E\u901A\u548C\u7279\u6B8A\u7ADE\u6280\u573A","Solving currently supports Normal and Special Arena only."));return}if(!ie(e)){i(n("\u6C42\u52A9\u961F\u4F0D\u6570\u636E\u5F02\u5E38\uFF0C\u65E0\u6CD5\u8F7D\u5165","Request team data is invalid."));return}r.helpCenter.solveRequestId=e.id,r.helpCenter.solveRequestTitle=e.title||"",r.helpCenter.solveRequestRegion=e.region||e.defensePayload?.region||"",g(),F(),D.teamSlots?.scrollIntoView({behavior:"smooth",block:"start"}),i(n("\u5DF2\u8F7D\u5165\u6C42\u52A9\u9632\u5B88\uFF0C\u586B\u5199\u8FDB\u653B\u961F\u540E\u70B9\u5E95\u90E8\u6309\u94AE\u63D0\u4EA4","Defense loaded. Fill attack teams, then use the bottom submit button."))}}async function L(t){r.helpCenter.loading=!0,r.helpCenter.error="",r.helpCenter.mode="reports",m(t);try{const e=new URLSearchParams({reports:"1",limit:"30",reportStatus:r.helpCenter.reportStatus||"open"}),u=await fetch(`${$}?${e.toString()}`,{headers:await H(!0)}),l=await u.json().catch(()=>null);if(!u.ok||!l?.ok||!Array.isArray(l.data))throw new Error(l?.code||"LOAD_FAILED");r.helpCenter.reports=l.data}catch(e){r.helpCenter.error=h(e),console.warn("[HelpCenter] reports failed",e)}finally{r.helpCenter.loading=!1,m(t)}}async function X(t,e,u="reviewed"){try{await C({action:"review_report",reportId:e,status:u}),i(n("\u4E3E\u62A5\u72B6\u6001\u5DF2\u66F4\u65B0","Report status updated.")),await L(t)}catch(l){console.warn("[HelpCenter] review report failed",l),i(h(l))}}async function Ae(t,e){const u=(r.helpCenter.reports||[]).find(l=>l.id===e);if(u?.targetId)try{await C({action:u.targetType==="solution"?"hide_solution":"hide_request",id:u.targetId}),await C({action:"review_report",reportId:e,status:"reviewed"}),i(n("\u5DF2\u9690\u85CF\u88AB\u4E3E\u62A5\u5185\u5BB9","Reported content hidden.")),await L(t)}catch(l){console.warn("[HelpCenter] hide report target failed",l),i(h(l))}}function A(t,e){return String(t||"").trim().slice(0,e)}function k(t){return t?.displayName||n("\u533F\u540D\u7528\u6237","Anonymous")}function Ee(t){const e=k(t),u=Number(t?.acceptedSolutionCount||0);return u<=0?e:`${e} \xB7 ${n("\u91C7\u7EB3","Accepted")} ${u}`}function h(t){const e=String(t?.message||"");return e==="UNAUTHENTICATED"?n("\u8BF7\u5148\u767B\u5F55","Please sign in first."):e==="RATE_LIMITED"?n("\u64CD\u4F5C\u8FC7\u4E8E\u9891\u7E41\uFF0C\u8BF7\u7A0D\u540E\u518D\u8BD5","Too many actions. Try again later."):e==="INVALID_PAYLOAD"?n("\u961F\u4F0D\u6570\u636E\u4E0D\u5B8C\u6574\u6216\u683C\u5F0F\u5F02\u5E38","Team payload is incomplete or invalid."):e==="DUPLICATE_SOLUTION"?n("\u8FD9\u4E2A\u8FDB\u653B\u961F\u4F0D\u5DF2\u7ECF\u63D0\u4EA4\u8FC7\u89E3\u6CD5","This attack team has already been submitted."):e==="REQUEST_CLOSED"?n("\u8BE5\u6C42\u52A9\u5DF2\u5173\u95ED","This request is closed."):e==="SELF_SOLUTION_NOT_ALLOWED"?n("\u4E0D\u80FD\u7ED9\u81EA\u5DF1\u7684\u6C42\u52A9\u63D0\u4EA4\u89E3\u6CD5","You cannot submit a solution to your own request."):e==="SELF_VOTE_NOT_ALLOWED"?n("\u4E0D\u80FD\u7ED9\u81EA\u5DF1\u7684\u89E3\u6CD5\u70B9\u8D5E","You cannot vote for your own solution."):e==="TARGET_TYPE_INVALID"||e==="TARGET_REQUIRED"||e==="NOT_FOUND"?n("\u4E3E\u62A5\u5BF9\u8C61\u4E0D\u5B58\u5728","Report target not found."):n("\u6C42\u52A9\u64CD\u4F5C\u5931\u8D25","Help center action failed.")}function q(t,e,u={}){const l=le(t,e);return l.length?l.length>1&&u.compactStack?`
    ...
    `:l.map((s,d)=>{const o=l.length>1?`R${d+1}`:e==="attack"?n("\u8FDB\u653B","ATK"):"";return`
    <div class="help-center-team-row${o?"":" is-label-hidden"}">
      ${o?`<span class="help-center-round">${a(o)}</span>`:""}
      <div class="help-center-members">
        ${Array.from({length:R},(p,f)=>{const b=B(s?.[f]);return`
            <span class="help-center-member${z(b)}" title="${a(b?j(b):"-")}">
              ${b?V(b):'<span class="avatar-fallback"><span class="avatar-fallback-name">?</span></span>'}
            </span>
          `}).join("")}
      </div>
    </div>
  `}).join(""):`<p class="help-center-empty">${a(n("\u6682\u65E0\u961F\u4F0D","No team"))}</p>`}function Re(t={}){const{className:e="",title:u="",meta:l="",actions:s="",noteLabel:d="",note:o="",teamLabel:p="",teamPayload:f=null,teamSide:b="defense"}=t;return`
    <article class="help-center-display-card${e?` ${e}`:""}">
      <div class="help-center-display-head">
        ...
        ${s?`<div class="help-center-display-actions">${s}</div>`:""}
      </div>
      ${o?`
        <div class="help-center-display-section help-center-display-note">
          <span>${a(d)}</span>
          <p class="help-center-description">${a(o)}</p>
        </div>
      `:""}
  ...
  `}function Te(){const t=r.helpCenter.filters||{};return`
    ...
    ${oe("help-center-touch-card-v1",n("\u7ADE\u6280\u573A\u4E92\u52A9\u600E\u4E48\u7528\uFF1F","How arena help works"),n("\u53D1\u5E03\u9632\u5B88\u6C42\u52A9\u540E\uFF0C\u5176\u4ED6\u4EBA\u53EF\u4EE5\u70B9\u201C\u53BB\u89E3\u9898\u201D\u8F7D\u5165\u9632\u5B88\uFF0C\u586B\u5199\u8FDB\u653B\u961F\u4F0D\u5E76\u63D0\u4EA4\u89E3\u6CD5\u3002","Post a defense request; others can solve it by loading the locked defense, filling attack teams, and submitting a solution."))}
  ...
  `}function _e(){const t=r.helpCenter.detail;if(r.helpCenter.loading&&!t)return`<p class="help-center-empty champion-data-loading">${a(n("\u6B63\u5728\u8BFB\u53D6\u6C42\u52A9\u8BE6\u60C5","Loading help detail"))}</p>`;if(r.helpCenter.error)return`<p class="help-center-error">${a(r.helpCenter.error)}</p>`;const e=t?.request;if(!e)return`<p class="help-center-empty">${a(n("\u672A\u627E\u5230\u6C42\u52A9","Request not found"))}</p>`;const u=[...t?.solutions||[]].sort((o,p)=>e.acceptedSolutionId===o.id?-1:e.acceptedSolutionId===p.id?1:0),l=U(w(),e.arenaMode),s=!!((e.isMine||e.canModerate)&&e.status==="open"),d=`${a(P(e.arenaMode))} ${_(e.region||e.defensePayload?.region)} <span class="help-center-status-badge is-${e.status==="closed"?"closed":"open"}">${e.status==="closed"?a(n("\u5DF2\u5173\u95ED","Closed")):a(n("\u6C42\u89E3\u4E2D","Open"))}</span> ${a(k(e.author))}`;return`
    <div class="help-center-toolbar">
      <button class="help-center-action-button" type="button" data-help-back>${a(n("\u8FD4\u56DE","Back"))}</button>
    ...
    <section class="help-center-section help-center-solutions-section">
      ...
      <div class="help-center-solution-list">
        ${u.length?u.map((o,p)=>{const f=e.acceptedSolutionId===o.id,b=`#${p+1}${f?` \xB7 ${n("\u5DF2\u91C7\u7EB3","Accepted")}`:""} \xB7 ${Ee(o.author)}`,ee=`
            ${s?`<button class="help-center-action-button is-primary" type="button" data-help-accept="${a(o.id)}">${a(n("\u91C7\u7EB3\u5E76\u5173\u95ED","Accept and close"))}</button>`:""}
            ${o.isMine?"":`<button class="help-center-action-button" type="button" data-help-report-solution="${a(o.id)}">${a(n("\u4E3E\u62A5","Report"))}</button>`}
            ${e.canModerate?`<button class="help-center-action-button" type="button" data-help-hide-solution="${a(o.id)}">${a(n("\u9690\u85CF","Hide"))}</button>`:""}
            ${o.isMine?`<span class="help-center-self-vote">${a(n("\u81EA\u5DF1\u7684\u89E3\u6CD5","Own solution"))} \xB7 ${Number(o.voteCount||0)}</span>`:`<button class="help-center-action-button" type="button" data-help-vote="${a(o.id)}">${o.votedByMe?a(n("\u5DF2\u8D5E","Voted")):a(n("\u70B9\u8D5E","Vote"))} \xB7 ${Number(o.voteCount||0)}</button>`}
          `;return Re({className:`is-solution${f?" is-accepted":""}`,title:b,actions:ee,noteLabel:n("\u89E3\u6CD5\u8BF4\u660E","Solution note"),note:o.description,teamLabel:n("\u8FDB\u653B\u961F\u4F0D","Attack teams"),teamPayload:o.attackPayload,teamSide:"attack"})}).join(""):`<p class="help-center-empty">${a(n("\u6682\u65E0\u89E3\u6CD5\u3002\u70B9\u51FB\u201C\u53BB\u89E3\u9898\u201D\u4F1A\u8FDB\u5165\u4E92\u52A9\u89E3\u9898\u6A21\u5F0F\uFF0C\u9632\u5B88\u961F\u4F0D\u4F1A\u81EA\u52A8\u9501\u5B9A\uFF0C\u53EA\u9700\u8981\u586B\u5199\u8FDB\u653B\u961F\u4F0D\u3002",'No solutions yet. Click "Solve" to enter help-solving mode: the defense is locked, and you only need to fill attack teams.'))}</p>`}
      </div>
    </section>
  ...
  `,document.body.append(e),document.addEventListener("keydown",Y),e.querySelector(".help-modal-close")?.addEventListener("click",g),m(e),t.requestId?y(e,t.requestId):S(e)}export{g as closeHelpCenterModal,Ie as openHelpCenterModal,te as setHelpCenterUiApi};
