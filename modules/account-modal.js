let f={};const U="nikke-pending-invite-code-v1",h=new Proxy({},{get(t,r){return f.state?.[r]},set(t,r,s){return f.state&&(f.state[r]=s),!0}});function K(t={}){f=t||{}}function o(t){const r=f[t];if(typeof r!="function")throw new Error("account modal api missing: "+t);return r}function T(...t){return o("getAuthSessionEmail")(...t)}function $(...t){return o("getAccountProfileDisplayName")(...t)}function E(...t){return o("getAuthSessionUsername")(...t)}function L(...t){return o("hasAccountProfileChangedEffectiveDisplayName")(...t)}function n(...t){return o("escapeHtml")(...t)}function e(...t){return o("localize")(...t)}function M(...t){return o("getPendingInviteCode")(...t)}function R(...t){return o("loadExternalApiKeyPanel")(...t)}function D(...t){return o("loadInvitePanel")(...t)}function z(...t){return o("openLegalModal")(...t)}function w(...t){return o("supabaseAuthRequest")(...t)}function S(...t){return o("saveAuthSession")(...t)}function m(...t){return o("showToast")(...t)}function P(...t){return o("normalizeUsername")(...t)}function I(...t){return o("validateUsername")(...t)}function _(...t){return o("updateAccountDisplayName")(...t)}function x(...t){return o("getAuthErrorMessage")(...t)}function F(...t){return o("validateAccountPassword")(...t)}function q(...t){return o("getAuthRedirectUrl")(...t)}function V(...t){return o("isExistingEmailSignupPayload")(...t)}function C(...t){return o("normalizeSupabaseAuthSession")(...t)}function N(...t){return o("refreshAccountStatus")(...t)}function H(...t){return o("acceptPendingInviteIfNeeded")(...t)}function B(...t){return o("hydrateAuthSessionUserIfNeeded")(...t)}function O(...t){return o("normalizeInviteCode")(...t)}function Y(...t){return o("canUseAccountFeature")(...t)}function G(t){const r=h.authSession,s=T(r),a=h.accountProfile||{},l=$()||E(r),g=!L(a),i=t==="update-password";if(s&&!i)return`
      ...
      ${d?"":`
        <div class="account-password-block">
          <label>
            ...
            <input id="accountPasswordInput" name="password" type="password" autocomplete="${c||i?"new-password":"current-password"}" autocapitalize="none" autocorrect="off" spellcheck="false" required minlength="${c||i?"8":"6"}" placeholder="${n(i?e("\u8BF7\u8F93\u5165\u65B0\u5BC6\u7801","Enter new password"):e("\u8BF7\u8F93\u5165\u5BC6\u7801","Enter password"))}" />
          </label>
  ...
  `,r.querySelector(".account-modal").addEventListener("click",a=>a.stopPropagation()),r.querySelector(".help-modal-close")?.addEventListener("click",A),document.body.append(r),b(r,t)}export{X as openAccountModal,K as setAccountModalApi};
